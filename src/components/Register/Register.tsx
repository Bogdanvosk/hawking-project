...
const Register = ({ onSetAuthMode }: { onSetAuthMode: () => void }) => {
					...
					<div className={styles.row}>
							...
							{Object.keys(errors).length > 0 && (
								<div className={styles.error}>
									...
									<svg
										...
										fill='none'
										xmlns='http://www.w3.org/2000/svg'>
										<g clipPath='url(#clip0_2831_1667)'>
											<path
						...
						<div className={styles.rules}>
							<p className={styles.rulesText}>
								...
								<br /> • добавлять фотографии объектов
								соответствующие действительности. Администрация
								сайта sdaem.by оставляет за собой право удалять
								любую информацию, размещенную пользователем,
								если сочтет, что информация не соответствует
							...
							<span className={styles.signin}>
								Уже есть аккаунт?{' '}
								<button onClick={onSetAuthMode}>Войдите</button>
							</span>
						</div>
					</div>
				</div>
